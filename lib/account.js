...
const Account = exports.Account = Class({
    ...
    check: function() {
        this.loginPromise({
            ...
            // Grab the globals... but be safe here, serialize to JSON and
            // back again to make sure we don't accidentally touch anything
            // other than a GLOBALS getter.
            let globals = JSON.parse(JSON.stringify(sandbox.GLOBALS || []));
